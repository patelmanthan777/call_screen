...
public class FragmentVideoTab extends Fragment implements OnListItemClickListener {
    ...
    private int vissibleThreshold = 1;
    ...
    public static FragmentVideoTab newInstance(String someInt) {
        FragmentVideoTab myFragment = new FragmentVideoTab();
